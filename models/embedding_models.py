...
def keyframe_embedding_model__bigru(n_classes=13606, n_genres=20, input_shape=(224,224,3), sequence_length=20, \
    ...
    lstm = keras.layers.Bidirectional(keras.layers.GRU(256, return_sequences=True, dropout=0.2, name='bigru_1'))(features)
    lstm2 = keras.layers.Bidirectional(keras.layers.GRU(256, return_sequences=False, dropout=0.2, name='bigru_2'))(lstm)
